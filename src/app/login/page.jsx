...
import { FaEnvelope, FaLock, FaEye, FaEyeSlash, FaCar } from 'react-icons/fa';
                    ...
                    <div className="relative z-10">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-400 text-sm md:text-base">
                                Login to access your AutoNest account
                            </p>
                        </div>

                        <form onSubmit={handleLogin} className="space-y-4">
                            <div>
                                <label className="block text-red-500 text-[10px] font-black uppercase mb-2 ml-1 tracking-widest">
                                    Email Address
                                </label>
                                <div className="relative group">
                                    <input
                                        ...
                                        className="w-full bg-black/50 px-3 text-white border-2 border-white/5 py-3 pl-11 pr-3 rounded-xl focus:border-red-600 focus:bg-black outline-none transition-all text-sm placeholder:text-gray-700 font-medium"
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative group">
                                    <input
                                        ...
                                        className="w-full px-3 bg-black/50 text-white border-2 border-white/5 py-3 pl-11 pr-12 rounded-xl focus:border-red-600 focus:bg-black outline-none transition-all text-sm placeholder:text-gray-700 font-medium"
                                    />
                                    <button
                                        type="button"
                                        onClick={() => setShowPassword(!showPassword)}
                                        className="absolute cursor-pointer mt-3 right-3 z-50"
                                    >
                                        {showPassword ? (
                            ...
                            <div className="flex justify-end">
                                <Link
                                    ...
                                    className="text-red-600 text-xs hover:text-red-500 font-bold transition-colors"
                                >
                                    Forgot Password?
                                </Link>
                            </div>
                            ...
                            <button
                                type="submit"
                                className="w-full bg-red-600 hover:bg-red-700 text-white font-black py-4 rounded-xl transition-all duration-300 active:scale-95 shadow-xl shadow-red-900/20 uppercase tracking-widest text-sm mt-2 cursor-pointer"
                            >
                                Login to Account
                            </button>
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-3 w-full bg-transparent hover:bg-red-600 border-2 border-red-600 text-white font-bold py-3 px-4 rounded-xl transition-all duration-300 group shadow-lg cursor-pointer"
                            >
                        ...
                        <div className="mt-8 text-center">
                            <p className="text-gray-500 text-xs font-bold">
                                ...
                                <Link
                                    href="/register"
                                    className="text-red-600 font-black hover:text-red-500 transition-colors ml-1 uppercase"
                                >
                                    Create Account
                                </Link>
                            </p>
